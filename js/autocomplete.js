...
(function (global, factory) {
  ...
  function () {
    ...
    _createClass(autoComplete, [{
      key: "search",
      value: function search(query, parent, record) {
		if(Array.isArray(record))
		{
			record = record.join(", ");
		}
		
		var affixes = parent["affixes"];
		if(Array.isArray(affixes))
		{
			affixes = affixes.join(", ");
		}
		
		record = "<i>" + affixes + "</i>" + " - " + record;
        ...
        return new Promise(function (resolve) {
          ...
          data.filter(function (record, index) {
            var search = function search(key) {
              ...
              if (recordValue) {
                var match = typeof _this.searchEngine === "function" ? _this.searchEngine(_this.queryValue, recordValue) : _this.search(_this.queryValue, record, recordValue);
                if (match && key) {
                  resList.push({
                    key: key,
                    index: index,
